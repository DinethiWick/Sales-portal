...
public class ProductController extends AbstractController{
    ...
    @GetMapping("products")
    ResponseEntity<ResponseObject> getAllProducts(@RequestParam(value = "query", required = false) String query){
        return sendSuccessResponse(productService.getProducts(query));
    }
